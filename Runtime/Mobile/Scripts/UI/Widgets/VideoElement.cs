...
namespace Twinny.UI
{
    ...
    [UxmlElement]
    public partial class VideoElement : CardElement
    {
        ...
        private void LoadMediaClip(VideoClip clip)
        {
            if (clip == null) return;
        ...
        private void OnVideoPrepared(VideoPlayer source)
        {
            ...
            m_backgroundElement.style.backgroundImage = Background.FromRenderTexture(m_renderTexture);
