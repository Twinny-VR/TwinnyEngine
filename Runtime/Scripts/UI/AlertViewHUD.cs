    ...
    private void Post(string message, MessageType type)
    {
        switch (type)
        {
            case MessageType.Info:
                ...
                _messageTypeTextField.text = LanguageManager.GetTranslated("Info");
                break;
            case MessageType.Warning:
                _messageTypeIconField.sprite = _warningIcon;
                _messageTypeTextField.text = LanguageManager.GetTranslated("Warning");
                break;
            case MessageType.Error:
                _messageTypeIconField.sprite = _errorIcon;
                _messageTypeTextField.text = LanguageManager.GetTranslated("Error");
                break;
        }
